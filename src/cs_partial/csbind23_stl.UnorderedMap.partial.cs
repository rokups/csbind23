...
public sealed partial class UnorderedMap<T0, T1>
{
    ...
    internal static UnorderedMap<T0, T1> FromOwnedHandle(System.IntPtr handle, global::CsBind23.Generated.ItemOwnership itemOwnership = global::CsBind23.Generated.ItemOwnership.Owned)
    {
        if (handle == System.IntPtr.Zero)
        {
            return new UnorderedMap<T0, T1>(itemOwnership);
        }

        return new UnorderedMap<T0, T1>(handle, global::CsBind23.Generated.ItemOwnership.Owned, itemOwnership);
    }

    internal static UnorderedMap<T0, T1> FromBorrowedHandle(System.IntPtr handle, global::CsBind23.Generated.ItemOwnership itemOwnership = global::CsBind23.Generated.ItemOwnership.Owned)
    {
        if (handle == System.IntPtr.Zero)
        {
            return new UnorderedMap<T0, T1>(itemOwnership);
        ...
        return new UnorderedMap<T0, T1>(handle, global::CsBind23.Generated.ItemOwnership.Borrowed, itemOwnership);
    }
    ...
    internal static void DestroyOwnedHandle(System.IntPtr handle, global::CsBind23.Generated.ItemOwnership itemOwnership = global::CsBind23.Generated.ItemOwnership.Owned)
    {
        ...
        using var owner = new UnorderedMap<T0, T1>(handle, global::CsBind23.Generated.ItemOwnership.Owned, itemOwnership);
    }

    internal static System.IntPtr CloneOrCreateOwned(UnorderedMap<T0, T1> value)
    {
        var clone = new UnorderedMap<T0, T1>(value?._itemOwnership ?? global::CsBind23.Generated.ItemOwnership.Owned);
        if (value != null)
        {
